    ...
    <div className="space-y-6">
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        ...
        <TabsContent value="positions" className="mt-6">
          <PositionsDetailPanel positions={positions} isLoading={isLoading} />
        </TabsContent>
...
const PositionsDetailPanel: React.FC<{ positions: any[], isLoading: boolean }> = ({ positions, isLoading }) => {
...
const PositionDetails: React.FC<{ position: any }> = ({ position }) => {
